...
return {
   ...
   -- 旧 曹仁
	...
	["$nosenyuan1"] = "重用许靖，以眩远近。",
	["$nosenyuan2"] = "给你的，十倍奉还给我！",
	...
	-- 旧 王异
	["$noszhenlie1"] = "我，决不屈服！", -- 回合外
	["$noszhenlie2"] = "看看我的觉悟吧！", -- 回合内
	["$nosmiji1"] = "我将尽我所能。",
	["$nosmiji2"] = "我将尽我所能。", -- 自己
	["$nosmiji3"] = "我将尽我所能。", -- 他人
	["$nosmiji4"] = "我将尽我所能。", -- 马超
