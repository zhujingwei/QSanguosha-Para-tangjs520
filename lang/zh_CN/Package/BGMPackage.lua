...
return {
	...
	["lihun"] = "离魂",
	[":lihun"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以弃置一张牌将武将牌翻面，并选择一名男性角色：若如此做，你获得该角色的所有手牌，且出牌阶段结束时，你交给该角色X张牌。（X为该角色的体力值）",
	...
	["manjuan"] = "漫卷",
	[":manjuan"] = "每当你将获得一张手牌时，你将之置入弃牌堆。若你的回合内你发动“漫卷”，你可以获得弃牌堆中一张与此牌同点数的牌（不能发动“漫卷”）。",
	["zuixiang"] = "醉乡",
	...
	["$ManjuanGot"] = "%from 即将获得 %card 并将此牌置入弃牌堆",
	...
	["dahe"] = "大喝",
	[":dahe"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以与一名其他角色拼点：若你赢，你可以将该角色的拼点牌交给一名体力值不大于你的角色，本回合该角色使用的非红桃【闪】无效；若你没赢，你展示所有手牌，然后弃置一张手牌。",
	["@dahe-give"] = "你可以将拼点牌交给一名体力值不大于你的角色",
	...
	["tanhu"] = "探虎",
	[":tanhu"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以与一名其他角色拼点：若你赢，你无视与该角色的距离，你使用的非延时锦囊牌对该角色结算时不能被【无懈可击】响应，直到回合结束。",
	["mouduan"] = "谋断",
	...
	["zhaolie"] = "昭烈",
	[":zhaolie"] = "摸牌阶段，你可以少摸一张牌并选择你攻击范围内的一名角色：若如此做，你亮出牌堆顶的三张牌，将其中的非基本牌和【桃】置入弃牌堆，然后该角色选择一项：1.受到X点伤害，然后获得其余的牌；2.弃置X张牌，然后令你获得其余的牌。（X为其中非基本牌的数量）",
	["zhaolie_obtain:obtain"] = "你可以点击确定令 %src 获得“昭烈”牌，否则你获得这些牌",
	["@zhaolie-discard"] = "你可以弃置 %arg 张牌令 %src 获得“昭烈”牌，否则你受到 %arg 点伤害并获得这些牌",
	["zhaolie-invoke"] = "你可以发动“昭烈”<br> <b>操作提示</b>: 选择攻击范围内的一名角色→点击确定<br/>",
	["shichou"] = "誓仇",
	[":shichou"] = "<font color=\"orange\"><b>主公技</b></font>，<font color=\"red\"><b>限定技</b></font>，准备阶段开始时，你可以选择一名其他蜀势力角色并交给其两张牌。每当你受到伤害时，你将此伤害转移给该角色，此伤害结算后该角色摸X张牌，直到其第一次进入濒死状态时。（X为伤害点数）",
	...
	["yanxiao"] = "言笑",
	[":yanxiao"] = "出牌阶段，你可以将一张方块牌置于一名角色的判定区内，称为“言笑牌”。判定区内有“言笑牌”的角色的判定阶段开始时获得其判定区内所有牌。",
	["YanxiaoCard"] = "言笑牌",
	["anxian"] = "安娴",
	[":anxian"] = "每当你使用【杀】对目标角色造成伤害时，你可以防止此伤害：若如此做，该角色弃置一张手牌，然后你摸一张牌。每当你成为【杀】的目标时，你可以弃置一张手牌：若如此做，此【杀】的使用者摸一张牌，此【杀】对你无效。",
	...
	["brocade"] = "锦",
	["junwei"] = "军威",
	[":junwei"] = "结束阶段开始时，你可以将三张“锦”置入弃牌堆并选择一名角色：若如此做，该角色可以展示一张【闪】并将之交给由你选择的一名角色，否则该角色失去1点体力，你将其装备区的一张牌移出游戏：若如此做，该角色的回合结束后，将这张装备牌移回其装备区（代替原装备）。",
	...
	["fenyong"] = "愤勇",
	[":fenyong"] = "每当你受到伤害后，你可以竖置体力牌。一名角色的结束阶段开始时，若你的体力牌处于竖置状态，你横置之。每当你受到伤害时，若你的体力牌处于竖置状态，防止此伤害。",
	["xuehen"] = "雪恨",
	[":xuehen"] = "<font color=\"blue\"><b>锁定技</b></font>，每当你的体力牌横置时，你选择一项：1.弃置当前回合角色X张牌。 2.视为你使用一张无距离限制的【杀】。（X为你已损失的体力值）",
	...
	["zhaoxin"] = "昭心",
	[":zhaoxin"] = "摸牌阶段结束时，你可以展示所有手牌：若如此做，视为你使用一张【杀】。",
	["@zhaoxin"] = "你可以发动“昭心”",
	["~zhaoxin"] = "选择【杀】的目标角色→点击确定",
	["langgu"] = "狼顾",
	[":langgu"] = "每当你受到1点伤害后，你可以进行判定且你可以打出一张手牌代替此判定牌：若如此做，你观看伤害来源的所有手牌，然后你可以弃置其中至少一张与判定牌花色相同的牌。",
	...
	["fuluan"] = "扶乱",
	[":fuluan"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，若你未于出牌阶段使用过【杀】，你可以弃置三张相同花色的牌并选择攻击范围内的一名角色：若如此做，该角色将武将牌翻面，你不能使用【杀】直到回合结束。",
	["shude"] = "淑德",
	...
	["huangen"] = "皇恩",
	[":huangen"] = "每当至少两名角色成为非延时锦囊牌的目标后，你可以令其中至多X名角色各摸一张牌，然后此牌对这些角色无效。（X为你的体力值）",
	["hantong"] = "汉统",
	...
	["diyyicong"] = "義從",
	[":diyyicong"] = "弃牌阶段结束时，你可以将至少一张牌置于武将牌上，称为“扈”。其他角色与你的距离+X。（X为“扈”的数量）",
	["tuqi"] = "突骑",
	[":tuqi"] = "<font color=\"blue\"><b>锁定技</b></font>，准备阶段开始时，若你的武将牌上有“扈”，你将所有“扈”置入弃牌堆：若X小于或等于2，你摸一张牌。本回合你与其他角色的距离-X。（X为以此法置入弃牌堆的“扈”的数量）",
	["retinue"] = "扈",
	["@diyyicong"] = "你可以发动“義從”",
