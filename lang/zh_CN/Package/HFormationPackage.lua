...
return {
	...
	["shangyi:generals"] = "暗将",
	["niaoxiang"] = "鸟翔",
	[":niaoxiang"] = "每当一名角色成为【杀】的目标后，若你与此【杀】使用者均与该角色相邻，你可以令该角色须使用两张【闪】抵消此【杀】。",
	...
	["yicheng"] = "疑城",
	[":yicheng"] = "每当一名角色成为【杀】的目标后，你可以令该角色摸一张牌，然后弃置一张牌。",
	...
	["qianhuan"] = "千幻",
	[":qianhuan"] = "每当一名角色受到伤害后，该角色可以将牌堆顶的一张牌置于你的武将牌上：若此牌与一张其他“千幻牌”花色相同，将之置入弃牌堆。每当一名角色成为基本牌或锦囊牌的唯一目标时，若该角色同意，你可以将一张“千幻牌”置入弃牌堆：若如此做，取消该目标。",
