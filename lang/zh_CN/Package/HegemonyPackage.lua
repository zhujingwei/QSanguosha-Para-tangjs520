...
return {
	...
	["fenxun"] = "奋迅",
	[":fenxun"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以弃置一张牌并选择一名其他角色：若如此做，本回合你无视与该角色的距离。",

	["#mateng"] = "驰骋西陲",
	["mateng"] = "马腾",
	["illustrator:mateng"] = "DH",
	["xiongyi"] = "雄异",
	[":xiongyi"] = "<font color=\"red\"><b>限定技</b></font>，出牌阶段，你可以令你与任意数量的其他角色摸三张牌：若以此法摸牌的角色数不大于全场角色数的一半，你回复1点体力。",
