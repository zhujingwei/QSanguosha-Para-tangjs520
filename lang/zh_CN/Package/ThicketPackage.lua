...
return {
	...
	["huoshou"] = "祸首",
	[":huoshou"] = "<font color=\"blue\"><b>锁定技</b></font>，【南蛮入侵】对你无效。每当一名角色指定【南蛮入侵】的目标后，你成为【南蛮入侵】的伤害来源。",
	["zaiqi"] = "再起",
	...
	["dimeng"] = "缔盟",
	[":dimeng"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以弃置任意数量的牌并选择两名手牌数差等于该数量的其他角色：若如此做，这两名角色交换他们的手牌。",
	...
	["roulin"] = "肉林",
	[":roulin"] = "<font color=\"blue\"><b>锁定技</b></font>，每当你指定女性角色为【杀】的目标后，或成为女性角色的【杀】的目标后，目标角色须连续使用两张【闪】抵消此【杀】。",
	["benghuai"] = "崩坏",
	[":benghuai"] = "<font color=\"blue\"><b>锁定技</b></font>，结束阶段开始时，若你的体力值不为场上最少（或之一），你须选择一项：失去1点体力，或失去1点体力上限。",
	["benghuai:hp"] = "体力",
	["benghuai:maxhp"] = "体力上限",
	["baonue"] = "暴虐",
	[":baonue"] = "<font color=\"orange\"><b>主公技</b></font>，其他群雄角色造成伤害后，该角色可以进行判定：若结果为黑桃，你回复1点体力。",
