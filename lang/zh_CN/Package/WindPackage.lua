...
return {
	...
	["xiaoqiao"] = "小乔",
	["hongyan"] = "红颜",
	[":hongyan"] = "<font color=\"blue\"><b>锁定技</b></font>，你的黑桃牌均视为红桃牌。",
	["tianxiang"] = "天香",
	...
	["buqu"] = "不屈",
	[":buqu"] = "<font color=\"blue\"><b>锁定技</b></font>，每当你处于濒死状态时，你将牌堆顶的一张牌置于武将牌上：若无同点数的“不屈牌”，你回复至1点体力；否则你将此牌置入弃牌堆。若你有“不屈牌”，你的手牌上限等于“不屈牌”的数量。",
	["fenji"] = "奋激",
	...
	["guhuo"] = "蛊惑",
	[":guhuo"] = "你可以扣置一张手牌当做一张基本牌或非延时锦囊牌使用或打出，其他角色选择是否质疑：若无角色质疑，你展示此牌，取消不合法的目标并按你所述继续结算；若有角色质疑，中止质疑询问并展示此牌：若此牌为真，该角色获得“缠怨”（<font color=\"blue\"><b>锁定技</b></font>，你不能质疑“蛊惑”。若你的体力值为1，你的其他武将技能无效。），取消不合法的目标并按你所述继续结算；否则你将之置入弃牌堆。每名角色的回合限一次。",
	["chanyuan"] = "缠怨",
