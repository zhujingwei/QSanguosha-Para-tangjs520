...
return {
	...
	["junxing"] = "峻刑",
	[":junxing"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以弃置任意数量的手牌并选择一名其他角色：若如此做，该角色须弃置一张与你弃置的牌类型均不同的手牌，否则将武将牌翻面并摸X张牌。（X为你弃置的牌的数量）",
	...
	["mieji"] = "灭计",
	[":mieji"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以将一张黑色锦囊牌置于牌堆顶并选择一名有手牌的其他角色，该角色弃置一张锦囊牌，否则弃置两张非锦囊牌。",
	["@mieji-discard"] = "请弃置一张锦囊牌或两张非锦囊牌",
	["~miejidiscard"] = "选择一张锦囊牌或两张非锦囊牌→点击确定",
	["fencheng"] = "焚城",
	[":fencheng"] = "<font color=\"red\"><b>限定技</b></font>，出牌阶段，你可以令所有其他角色：弃置至少X张牌，否则受到2点火焰伤害。（X为上一名进行选择的角色以此法弃置的牌数+1）",
