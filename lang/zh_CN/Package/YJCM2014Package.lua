...
return {
	...
	["qieting:draw"] = "摸一张牌",
	["xianzhou"] = "献州",
	[":xianzhou"] = "<font color=\"red\"><b>限定技</b></font>，出牌阶段，你可以将装备区的所有牌交给一名其他角色，然后该角色选择一项：令你回复X点体力，或对其攻击范围内的X名角色各造成1点伤害。（X为你以此法给出的牌数）",
	...
	["shibei"] = "矢北",
	[":shibei"] = "<font color=\"blue\"><b>锁定技</b></font>，每当你于一名角色的回合内受到伤害后，若为你本回合第一次受到伤害，你回复1点体力，否则你失去1点体力。",
	...
	["zenhui"] = "谮毁",
	[":zenhui"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，每当你于出牌阶段内使用【杀】或黑色非延时类锦囊牌指定唯一目标时，你可以令为此牌合法目标的另一名其他角色选择一项：交给你一张牌并成为此牌的使用者，或成为此牌的目标。",
	...
	["desinger:wuyi"] = "沸治克里夫",
	["benxi"] = "奔袭",
	[":benxi"] = "<font color=\"blue\"><b>锁定技</b></font>，你的回合内，你与其他角色的距离-X。你的回合内，若你与所有其他角色距离均为1，其他角色的防具无效，你使用【杀】可以额外选择一个目标。（X为本回合你已使用结算完毕的牌数）",
	["#benxi-dist"] = "奔袭",
