...
return {
	...
	["xingshuai"] = "兴衰",
	[":xingshuai"] = "<font color=\"orange\"><b>主公技</b></font>，<font color=\"red\"><b>限定技</b></font>，当你进入濒死状态时，其他魏势力角色可依次令你回复1点体力，然后这些角色依次受到1点伤害。",
    ["_xingshuai:xing"] = "你可以令 %src 回复一点体力，然后你受到1点伤害" ,

	["#caoxiu"] = "千里骐骥",
	["caoxiu"] = "曹休",
	["taoxi"] = "讨袭",
	[":taoxi"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你使用牌指定一名其他角色为唯一目标后，你可以亮出其一张手牌直到回合结束，并且你可以于此回合内将此牌如手牌般使用。回合结束时，若该角色未失去此手牌，则你失去1点体力。",
	["&taoxi"] = "讨袭",

	["#gongsunyuan"] = "狡徒悬海",
	["gongsunyuan"] = "公孙渊",
	["huaiyi"] = "怀异", -- 怀孕！！
	[":huaiyi"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以展示所有手牌，若其中包含不止一种颜色，则你选择一种颜色并弃置该颜色的所有手牌，然后你获得至多X名其他角色的各一张牌（X为你以此法弃置的手牌数）；若你以此法获得的牌不少于两张，你失去1点体力。",
	...
	["qinwang"] = "勤王",
	[":qinwang"] = "<font color=\"orange\"><b>主公技</b></font>，你可以弃置一张牌，然后视为你发动“激将”。若有角色响应，则该角色打出【杀】时摸一张牌。",
	...
	["sunxiu"] = "孙休",
	["yanzhu"] = "宴诛",
	[":yanzhu"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以令一名有牌的其他角色选择一项：令你获得其装备区里所有的牌，然后你失去技能“宴诛”，直到游戏结束；或弃置一张牌。",
    ...
    ["~xingxue"] = "选择角色→点击确定" ,
    ["zhaofu"] = "诏缚",
	[":zhaofu"] = "<font color=\"orange\"><b>主公技</b></font>，<font color=\"blue\"><b>锁定技</b></font>，你距离为1的角色视为在其他吴势力角色的攻击范围内。",
	...
	["zhangyi"] = "张嶷",
	["furong"] = "怃戎",
	[":furong"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以令一名其他角色与你同时展示一张手牌：若你展示的是【杀】且该角色展示的不是【闪】，则你弃置此【杀】并对其造成1点伤害；若你展示的不是【杀】且该角色展示的是【闪】，则你弃置你展示的牌并获得其一张牌。",
	["@furong-show"] = "<font color=\"yellow\">抚戎</font> 请展示一张手牌" ,
    ["shizhi"] = "矢志",
	[":shizhi"] = "<font color=\"blue\"><b>锁定技</b></font>，当你体力为1时，你的【闪】均视为【杀】。",
	...
	["zhuzhi"] = "朱治",
	["anguo"] = "安国",
	[":anguo"] = "<font color=\"green\"><b>出牌阶段限一次</b></font>，你可以选择一名其他角色装备区里的一张牌，令其将此牌收回手牌。然后若该角色攻击范围内的角色数因此减少，你摸一张牌。",
