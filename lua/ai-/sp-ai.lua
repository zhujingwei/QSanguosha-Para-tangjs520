...
sgs.ai_use_priority.XuejiCard = 1
...
-- 影兵
sgs.ai_skill_invoke.yingbing = sgs.ai_skill_invoke.jizhi
...
-- 甚贤
sgs.ai_skill_invoke.shenxian = sgs.ai_skill_invoke.jizhi
...
-- 戚乱
sgs.ai_skill_invoke.qiluan = sgs.ai_skill_invoke.jizhi
