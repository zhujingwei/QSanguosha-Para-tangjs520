...
local zhanjue_skill={}
zhanjue_skill.name="shuangxiong"
...
zhanjue_skill.getTurnUseCard=function(self)
	...
	if not card or card:getSubcards():length() == 0 then return nil end
	local card_str = ("duel:shuangxiong[%s:%s]=%d"):format(suit, 0, card)
