...
sgs.ai_cardneed.renxin = sgs.ai_cardneed.equip
...
sgs.ai_cardneed.longyin = function(to, card)
	return card:isRed() and card:isKindOf("Slash")
end
...
sgs.ai_cardneed.mieji = function(to, card)
...
-- 暗箭
sgs.ai_cardneed.anjian = function(to, card)
