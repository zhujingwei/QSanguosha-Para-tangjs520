...
sgs.ai_cardneed.shenduan = function(to, card)
	return card:isKindOf("BasicCard") and card:isBlack()
end
...
sgs.ai_cardneed.yonglve = sgs.ai_cardneed.weapon
...
sgs.ai_cardneed.zenhui = function(to, card)
	return card:isKindOf("Slash") or (card:isNDTrick() and card:isBlack())
end
...
sgs.ai_cardneed.jiaojin = sgs.ai_cardneed.equip

-- 奔袭
sgs.ai_cardneed.benxi = sgs.ai_cardneed.mingce
...
sgs.ai_cardneed.zhongyong = sgs.ai_cardneed.lieren
