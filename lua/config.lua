...
--		"HegemonySP",
	...
	convert_pairs = {
		"caocao|nos_caocao",
		"simayi|nos_simayi",
		"xiahoudun|nos_xiahoudun|bgm_xiahoudun",
		"zhangliao|nos_zhangliao",
		"xuchu|nos_xuchu",
		"guojia|nos_guojia",
		"liubei|nos_liubei|bgm_liubei",
		"guanyu|nos_guanyu|sp_guanyu",
		"zhangfei|nos_zhangfei|bgm_zhangfei",
		"zhaoyun|nos_zhaoyun|bgm_zhaoyun|jsp_zhaoyun",
		"machao|nos_machao|sp_machao",
		"huangyueying|nos_huangyueying|jsp_huangyueying",
		"xushu|nos_xushu|st_xushu",
		"ganning|nos_ganning|bgm_ganning",
		"lvmeng|nos_lvmeng|bgm_lvmeng",
		"huanggai|nos_huanggai",
		"zhouyu|nos_zhouyu",
		"daqiao|nos_daqiao|bgm_daqiao",
		"luxun|nos_luxun",
		"sunshangxiang|sp_sunshangxiang",
		"huatuo|nos_huatuo",
		"lvbu|nos_lvbu",
		"diaochan|nos_diaochan|sp_diaochan|bgm_diaochan",
		"huaxiong|st_huaxiong",
		"yuanshu|st_yuanshu",
		"gongsunzan|st_gongsunzan",
		"caoren|nos_caoren|bgm_caoren",
		"zhoutai|nos_zhoutai",
		"zhangjiao|nos_zhangjiao",
		"yuji|nos_yuji",
		"pangtong|bgm_pangtong",
		"pangde|sp_pangde",
		"jiaxu|sp_jiaxu",
		"jiangwei|jsp_jiangwei",
